...
import pyperclip # pip install pyperclip-> to access clipboard
import pyautogui # pip install pyautogui ->to get coordinates of cursor and click event
...
def CookieScrapper():
    ...
    sleep(2)
    pyautogui.click(x=1775, y=70)
    sleep(1)
    pyautogui.click(x=1491, y=248)
    sleep(1)
    pyautogui.click(x=1511, y=99)
    sleep(1)
    ...
    data = pyperclip.paste() #save data from clipboard
...
def split_and_save_paragraphs(data, filename):
        # it split the answer in 2 para and join them with ,
        try:
...
def MainExecution():
    ...
    while True:
        ...
        try:
            imagename = str(input("Enter The Image Name/Path : "))
